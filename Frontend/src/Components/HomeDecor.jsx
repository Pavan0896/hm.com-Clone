...
const HomeDecor = () => {
  ...
  useEffect(() => {
    document.title = "Home Decor | H&M IN";
  }, []);
  ...
  useEffect(() => {
    ...
    dispatch(
      fetchData(
        `${url}/products/products?related_to=home${categoryParam}${sortParamString}`
      )
    );
        ...
        <Box display={"flex"} mt="3%" flexDirection={"column"} pb="5%">
          ...
          >
            ...
            >
              ...
              <option value="cushion">Cushions</option>
              <option value="bed spread">Bed Spreads</option>
